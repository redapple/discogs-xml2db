...
ALTER TABLE group_member ADD CONSTRAINT group_member_fk_member FOREIGN KEY (member_artist_id) REFERENCES artist(id);
...
--- masters
ALTER TABLE master ADD CONSTRAINT master_fk_main_release FOREIGN KEY (main_release) REFERENCES release(id);
